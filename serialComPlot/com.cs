...
{
    // reference :http://www.cnblogs.com/netlyf/p/4458927.html
...

    {
        ...
        public delegate void SerialPortDataReceiveEventArgs(object sender, SerialDataReceivedEventArgs e, string bits);
        ...
        public bool HexFlag
        {
            ...
            set
            {
                if (value.GetType() == typeof(bool))
                {
                    ...
                    throw new Exception("hexFlag is bool type");
            }
        }
